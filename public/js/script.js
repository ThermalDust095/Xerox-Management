...
function create_div(sampleOrder) {
  ...
  confirmationContainer.innerHTML = `
    <img src="img/accept.png" alt="Accept Image" class=action-image accept-order" id="accept-${sampleOrder.id}"> 
    <img src="img/reject.png" alt="Reject Image" class="action-image reject-order" id="reject-${sampleOrder.id}">`;
