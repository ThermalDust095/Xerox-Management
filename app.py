...
with app.app_context():
    db.create_all()
    admin = Client_Password.query.filter_by(username="admin").first()
    ...
    if not admin:
        ...
        # update existing admin password instead of inserting
        admin.password = "root"   # or new password
        db.session.commit()
...
def hello():
    ...
    return render_template("admin.html", password = p.password) 
